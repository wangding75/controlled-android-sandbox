...
int main(int argc, char** argv) {
    ...
    void* fixture = dlopen(fixture_path.c_str(), RTLD_NOW | RTLD_LOCAL);
    ...
    controlled_sandbox::global_policy().configure("hook-session", 1, "com.example.guest", 0,
    ...
    require_hook(status.target_relocations >= 5, "file targets discovered");
    require_hook(status.relocations_patched >= 5, "file targets patched");
    ...
    controlled_sandbox::global_policy().configure("hook-session", 2, "com.example.guest", 0,
            instance.string(), apk.string(), fixture_root.string(), true, {}, {}, {}, {});
