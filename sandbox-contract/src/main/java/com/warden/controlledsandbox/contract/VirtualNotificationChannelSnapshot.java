...
public final class VirtualNotificationChannelSnapshot implements Parcelable {
    ...
    private VirtualNotificationChannelSnapshot(Parcel in) {
        this(in.readString(), in.readString(), in.readString(), in.createByteArray(), in.readLong());
    }
    ...
    @Override public void writeToParcel(Parcel out, int flags) {
        out.writeString(kind); out.writeString(id); out.writeString(groupId); out.writeByteArray(payload); out.writeLong(updatedAtMs);
    }
