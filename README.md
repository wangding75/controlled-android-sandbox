...
- Guest-generation PendingIntent sender identity and Broker routing, plus a Package-Service-owned scoped Binder authority for cross-process Clipboard, basic Account, persistent Alarm metadata/callback ownership and persistent Notification/Job ID namespaces; Receiver authority remains extracted from the central Runtime Broker.
