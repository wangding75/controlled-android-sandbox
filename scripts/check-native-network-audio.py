...
for token in ['controlled_socket(', 'controlled_getnameinfo(', 'controlled_gethostname(',
              'controlled_getifaddrs(', 'controlled_AAudioStream_requestStart(',
...
for token in ['native_network_self_test', 'native_audio_self_test', 'native_network.cpp', 'native_audio.cpp']:
