...
OWNERS = (
    ...
    OwnerSpec("InvocationMethodMatcher", "sandbox-framework/src/main/java/com/warden/controlledsandbox/framework/contract/InvocationMethodMatcher.java", "sandbox-framework/src/testHarness/java/com/warden/controlledsandbox/framework/core/InvocationMethodMatcherSelfTest.java", r"\bInvocationMethodMatcher\s*\.\s*(?:named|startsWith|containsAny)\s*\("),
